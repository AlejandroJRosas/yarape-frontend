    ...
    <>
      ...
      <div className={clsx('flex flex-col w-full h-screen bg-[antiquewhite]')}>
        ...
        <div className={clsx('flex w-full h-full')}>
          <div
            className={clsx(
              'flex items-center justify-center w-full h-full bg-gradient-to-br from-neutral-800 to-neutral-500 relative'
            )}
          >
            <img
              src={araguaney}
            ...
            />
            <div className={clsx('w-3/5 text-white text-center')}>
              <h2 className={clsx('font-bold text-5xl pb-9')}>
                Calcula tu huella ecológica!
              </h2>
              <p className={clsx('text-2xl pb-7')}>
      ...
      <div className={clsx('w-full h-screen bg-[#734035]')}>
        <div className={clsx('flex w-full h-full items-center justify-around')}>
          <div className={clsx('text-white w-1/3')}>
            <h2 className={clsx('w-96 text-5xl font-bold pb-16')}>
          ...
          <div
            className={clsx(
              'flex w-[550px] h-[550px] items-center justify-center rounded-full bg-[#A95A5A]'
            )}
          >
            <img src={ecologia} className={clsx('w-[400px] h-[400px]')} />
          </div>
        </div>
      </div>

      {/* What is the meaning of Yarapë? */}
      <div className={clsx('w-full h-screen bg-[#FEE45A]')}>
        <div className={clsx('flex w-full h-full items-center justify-around')}>
          <div
            className={clsx(
              'flex w-[550px] h-[550px] items-center justify-center rounded-full bg-[#FFF8B2]'
            )}
          >
            <img src={pemon} className={clsx('w-[400px] h-[400px]')} />
          </div>
          <div className={clsx('text-black w-1/2')}>
            <h2 className={clsx('text-5xl font-bold pb-16')}>
